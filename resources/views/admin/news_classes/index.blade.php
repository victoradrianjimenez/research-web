  ...
  <div class="fade-in">
    <div class="card">
      <div class="card-header">
        <a href="{{route('news_classes.create')}}" class="btn btn-primary float-right">New...</a>
            ...
            <tr id="{{$name}}">
              ...
              <td>
                <div class="btn-group-sm float-right" role="group">
                  <a class="btn btn-warning" href="{{route('news_classes.edit',$name)}}">Edit</a>
                  <a class="btn btn-danger" data-toggle="modal" data-target="#modal_remove" href="#" 
                  onclick="remove_item_click(this,'{{route('news_classes.index')}}','alias')">Remove</a>
                </div>
              </td>
            </tr>
            @endforeach
