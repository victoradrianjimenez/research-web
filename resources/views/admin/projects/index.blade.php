  ...
  <div class="fade-in">
    <div class="card">
      <div class="card-header">
        <a href="{{route('projects.create')}}" class="btn btn-primary float-right">New...</a>
            ...
            <tr id="{{$p->id}}">
              ...
              <td>
                <div class="btn-group-sm float-right" role="group">
                  <a class="btn btn-info" href="{{route('project',$p->url)}}">View</a>
                  <a class="btn btn-warning" href="{{route('projects.edit',$p->id)}}">Edit</a>
                  <a class="btn btn-danger" data-toggle="modal" data-target="#modal_remove" href="#" 
                  onclick="remove_item_click(this,'{{route('projects.index')}}','alias')">Remove</a>
                </div>
              </td>
            </tr>
            @endforeach
